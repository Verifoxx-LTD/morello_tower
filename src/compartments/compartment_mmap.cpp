...
// __wrap_mmap64 is an alias for __wrap_mmap
__attribute__((default, alias("__wrap_mmap")))
extern "C" void* __wrap_mmap64(void* addr, size_t length, int prot, int flags, int fd, off_t offset);
